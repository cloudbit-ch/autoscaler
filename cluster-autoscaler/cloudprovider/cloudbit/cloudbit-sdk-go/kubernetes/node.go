...
func NewNodeService(client cloudbitgo.Client, clusterID int) NodeService {
	return NodeService{
		client:    client,
		clusterID: clusterID,
	}
...
func (n NodeService) List(ctx context.Context, cursor cloudbitgo.Cursor) (list NodeList, err error) {
...
func getNodePath(clusterID int) string {
	return cloudbitgo.Join(clusterSegment, clusterID, nodeSegment)
}

func getSpecificNodePath(clusterID, nodeID int) string {
	return cloudbitgo.Join(clusterSegment, clusterID, nodeSegment, nodeID)
}

func getNodeActionPath(clusterID, nodeID int) string {
	return cloudbitgo.Join(clusterSegment, clusterID, nodeSegment, nodeID, nodeActionSegment)
}
