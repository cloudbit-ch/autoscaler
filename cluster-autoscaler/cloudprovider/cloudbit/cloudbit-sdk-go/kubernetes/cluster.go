...
func NewClusterService(client cloudbitgo.Client) ClusterService {
...
func (c ClusterService) List(ctx context.Context, cursor cloudbitgo.Cursor) (list ClusterList, err error) {
...
func getSpecificClusterPath(id int) string {
	return cloudbitgo.Join(clusterSegment, id)
}

func getClusterKubeConfigPath(id int) string {
	return cloudbitgo.Join(clusterSegment, id, clusterKubeConfigSegment)
}

func getClusterConfigurationPath(id int) string {
	return cloudbitgo.Join(clusterSegment, id, clusterConfigurationSegment)
}

func getClusterFlavorPath(id int) string {
	return cloudbitgo.Join(clusterSegment, id, clusterFlavorSegment)
}

func getClusterActionPath(id int) string {
	return cloudbitgo.Join(clusterSegment, id, clusterActionSegment)
}
