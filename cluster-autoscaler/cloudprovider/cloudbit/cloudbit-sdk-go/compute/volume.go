...
func NewVolumeService(client cloudbitgo.Client) VolumeService {
...
func getSpecificVolumePath(volumeID int) string {
	return cloudbitgo.Join(volumesSegment, volumeID)
}

func getVolumeInstancesPath(volumeID int) string {
	return cloudbitgo.Join(volumesSegment, volumeID, volumeInstancesSegment)
}

func getSpecificVolumeInstancePath(volumeID, instanceID int) string {
	return cloudbitgo.Join(volumesSegment, volumeID, volumeInstancesSegment, instanceID)
}

func getVolumeRevertPath(volumeID int) string {
	return cloudbitgo.Join(volumesSegment, volumeID, volumeRevertSegment)
}

func getVolumeUpgradePath(volumeID int) string {
	return cloudbitgo.Join(volumesSegment, volumeID, volumeUpgradeSegment)
}
