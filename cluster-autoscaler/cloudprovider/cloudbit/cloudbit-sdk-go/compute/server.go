...
func NewServerService(client cloudbitgo.Client) ServerService {
...
func (s ServerService) List(ctx context.Context, cursor cloudbitgo.Cursor) (list ServerList, err error) {
...
func getSpecificServerPath(serverID int) string {
	return cloudbitgo.Join(serversSegment, serverID)
}

func getServerActionPath(serverID int) string {
	return cloudbitgo.Join(serversSegment, serverID, serverActionSegment)
}

func getServerUpgradePath(serverID int) string {
	return cloudbitgo.Join(serversSegment, serverID, serverUpgradeSegment)
}
