...
func NewNetworkInterfaceService(client cloudbitgo.Client, serverID int) NetworkInterfaceService {
...
func getNetworkInterfacesPath(serverID int) string {
	return cloudbitgo.Join(serversSegment, serverID, networkInterfacesSegment)
}

func getSpecificNetworkInterfacePath(serverID, networkInterfaceID int) string {
	return cloudbitgo.Join(serversSegment, serverID, networkInterfacesSegment, networkInterfaceID)
}

func getNetworkInterfaceSecurityPath(serverID, networkInterfaceID int) string {
	return cloudbitgo.Join(serversSegment, serverID, networkInterfacesSegment, networkInterfaceID, networkInterfaceSecuritySegment)
}

func getNetworkInterfaceSecurityGroupsPath(serverID, networkInterfaceID int) string {
	return cloudbitgo.Join(serversSegment, serverID, networkInterfacesSegment, networkInterfaceID, networkInterfaceSecurityGroupsSegment)
}
