...
func NewLoadBalancerService(client cloudbitgo.Client) LoadBalancerService {
...
func (l LoadBalancerService) List(ctx context.Context, cursor cloudbitgo.Cursor) (list LoadBalancerList, err error) {
...
func getSpecificLoadBalancerPath(loadBalancerID int) string {
	return cloudbitgo.Join(loadBalancerSegment, loadBalancerID)
}

func getLoadBalancerActionPath(loadBalancerID int) string {
	return cloudbitgo.Join(loadBalancerSegment, loadBalancerID, loadBalancerActionSegment)
}
