...
func NewLoadBalancerPoolService(client cloudbitgo.Client, loadBalancerID int) LoadBalancerPoolService {
...
func (l LoadBalancerPoolService) List(ctx context.Context, cursor cloudbitgo.Cursor) (list LoadBalancerPoolList, err error) {
...
func getLoadBalancerPoolsPath(loadBalancerID int) string {
	return cloudbitgo.Join(loadBalancerSegment, loadBalancerID, loadBalancerPoolsSegment)
}

func getSpecificLoadBalancerPoolPath(loadBalancerID, poolID int) string {
	return cloudbitgo.Join(loadBalancerSegment, loadBalancerID, loadBalancerPoolsSegment, poolID)
}
